...
const formSchema = z.object({
  ...
  paymentMethod: z.nativeEnum(TransactionPaymenyMethod, {
...
const AddTransactionButton = () => {
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      date: new Date(),
      name: "",
      paymentMethod: TransactionPaymenyMethod.CASH,
      ...
      >
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Insira as inforamações abaixo</DialogDescription>
          </DialogHeader>
          <Form {...form}>
